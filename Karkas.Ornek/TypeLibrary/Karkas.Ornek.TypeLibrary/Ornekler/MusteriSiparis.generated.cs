...
//::PRESERVE_END inheritance:://
		{
			...
			public string MusteriSiparisKeyAsString
			{
				...
				set
				{
					...
					{
						this.Onaylayici.OnaylayiciListesi.Add(new DaimaBasarisiz(this,"MusteriSiparisKey","Ceviri islemi Başarısız oldu"));
					}
				}
			}
			...
			public string TutarAsString
			{
				...
				set
				{
					...
					{
						this.Onaylayici.OnaylayiciListesi.Add(new DaimaBasarisiz(this,"Tutar","Ceviri islemi Başarısız oldu"));
					}
				}
			}
			...
			public string SiparisTarihiAsString
			{
				...
				set
				{
					...
					{
						this.Onaylayici.OnaylayiciListesi.Add(new DaimaBasarisiz(this,"SiparisTarihi","Ceviri islemi Başarısız oldu"));
					}
				}
			}
