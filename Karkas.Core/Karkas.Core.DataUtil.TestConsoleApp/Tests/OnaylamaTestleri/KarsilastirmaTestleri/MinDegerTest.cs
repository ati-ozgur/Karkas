...
{
    [TestFixture]
    public class MinDegerTest
    {
        [Test]
        public void TestMinDeger5()
        {
        ...
        private OrnekA ornekAOlustur(short pDeger)
        {
            ...
            a.Onaylayici.OnaylayiciListesi.Add(new MinDegerOnaylayici(a, "ShortDegisken", pDeger));
            return a;
        }
    }
}
