...
namespace Karkas.Core.DataUtil.TestConsoleApp.Tests.OnaylamaTestleri
{
    ...
    public class CompareTest
    {
        ...
        private OrnekKarsilastirma testIcinOrnekKarsilastirmaOlustur()
        {
            ...
            a.Onaylayici.OnaylayiciListesi.Add(new KarsilastirmaOnaylayici(a, "DogumTarihi",DateTime.Now.AddYears(-19),KarsilastirmaOperatoru.GreatThanEqual,"Kisi 18 yaşından büyük olmalıdır"));
            return a;
