...
namespace Karkas.Core.Utility.ReportingServicesHelper
{
    ...
    {
        //rapor almadan (RaporAl() fonksiyonundan) once çağırılacak event
        ...
        /// <summary>
        /// Raporların calıstıgı sunucunun adresi
        /// </summary>
        ...
        string raporDosyaAd;
        /// <summary>
        /// Raporun Sunucu Uzerindeki Adi, buranın dizin ile beraber verilmesi
        /// gerekir. MODUL_ADI/RAPOR_ADI , .rdl verilmez
        /// Report Manager uzerinde gorulen adı veriniz.
        /// </summary>
        ...
        /// <summary>
        /// Raporun save as ile kayıt edilirken gosterildigi ad.
        /// </summary>
