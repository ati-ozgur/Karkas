...
CREATE TABLE "Album"
(
    "AlbumId" NUMBER NOT NULL GENERATED BY DEFAULT,
...
CREATE TABLE "Artist"
(
    "ArtistId" NUMBER NOT NULL GENERATED BY DEFAULT,
    Name VARCHAR2(120),
...
(
    "CustomerId" NUMBER NOT NULL GENERATED BY DEFAULT,
...
(
    "EmployeeId" NUMBER NOT NULL GENERATED BY DEFAULT,
    "LastName" VARCHAR2(20) NOT NULL,
...
CREATE TABLE "Genre"
(
    "GenreId" NUMBER NOT NULL GENERATED BY DEFAULT,
    Name VARCHAR2(120),
...
(
    "InvoiceId" NUMBER NOT NULL GENERATED BY DEFAULT,
...
(
    "InvoiceLineId" NUMBER NOT NULL GENERATED BY DEFAULT,
...
(
    "MediaTypeId" NUMBER NOT NULL GENERATED BY DEFAULT,
    Name VARCHAR2(120),
...
(
    "PlaylistId" NUMBER NOT NULL GENERATED BY DEFAULT,
    Name VARCHAR2(120),
...
CREATE TABLE "Track"
(
    "TrackId" NUMBER NOT NULL GENERATED BY DEFAULT,
