...
(    
BLOB_EXAMPLE_KEY NUMBER(*,0) GENERATED ALWAYS AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
URL VARCHAR2(200 BYTE), 
ISTEK_ID VARCHAR2(36 BYTE) DEFAULT SYS_GUID(), 
ISTEK_JSON BLOB, 
CEVAP_JSON BLOB, 
ISTEYEN_KULLANICI_NAME VARCHAR2(50 BYTE)
);
