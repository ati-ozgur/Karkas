...
;
PROMPT === Table INT_TABLES created ===
...
;
PROMPT === Table DECIMAL_TO_INT_TABLES created ===
...
;
PROMPT === Table DECIMAL_TABLES created ===
...
PROMPT === Table ANSI_STRING created ===
...
PROMPT === Table ANSI_NUMERIC created ===
...
PROMPT === Table T_NUMBER_DATATYPES created ===
...
PROMPT === Table BLOB_EXAMPLE1 created ===
...
PROMPT === Table EMPLOYEE created ===

CREATE SEQUENCE TUM_ISLEM_HATA_TAKIP_SEQ
 START WITH     1
 INCREMENT BY   1
 NOCACHE
 NOCYCLE;

CREATE TABLE TUM_ISLEM_HATA_TAKIP
( ISLEM_TAKIP_KEY NUMBER DEFAULT TUM_ISLEM_HATA_TAKIP_SEQ.nextval,
ISLEM_TIP VARCHAR2(50 BYTE),
ISLEM_TARIH DATE,
CREATE_USER VARCHAR2(50 BYTE),
CREATE_DATE DATE,
SONUC VARCHAR2(5 BYTE),
HATA_MESAJI VARCHAR2(4000 BYTE),
CONSTRAINT PK_TUM_ISLEM_HATA_TAKIP PRIMARY KEY  (ISLEM_TAKIP_KEY)
);

PROMPT === Table TUM_ISLEM_HATA_TAKIP created ===
...
PROMPT === CONSTRAINT AND INDEXES CREATED ===
